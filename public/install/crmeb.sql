...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文章管理表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `eb_article`
--

INSERT INTO `eb_article` (`id`, `cid`, `title`, `author`, `image_input`, `synopsis`, `share_title`, `share_synopsis`, `visit`, `sort`, `url`, `status`, `add_time`, `hide`, `admin_id`, `mer_id`, `is_hot`, `is_banner`) VALUES
(1, '1', '测试', '测试', 'http://datong.crmeb.net/public/uploads/editor/20190115/5c3dc294a9a0a.jpg', '大撒旦', NULL, NULL, '143', 0, '', 0, '1548138209', 0, 1, 0, 1, 1),
(2, '1', '阿斯达斯', 'admin', 'http://datong.crmeb.net/public/uploads/editor/20190115/5c3dc294a9a0a.jpg', '阿斯达', NULL, NULL, '62', 0, NULL, 0, '1552965683', 0, 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `eb_article_category` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文章分类表' AUTO_INCREMENT=4 ;
...
(1, 0, '测试', '123', 'http://datong.crmeb.net/public/uploads/editor/20190115/5c3dc294a9a0a.jpg', 1, 0, 1, '1548138187', 0),
(2, 0, '开发者专区', '微信小程序开发者专区', 'http://datong.crmeb.net/public/uploads/editor/20190111/5c387daf3ef63.jpg', 1, 1, 0, '1554889503', 0),
(3, 0, '官方动态', 'CRMEB官方动态', 'http://datong.crmeb.net/public/uploads/editor/20190111/5c387d18c37fa.jpg', 1, 2, 0, '1554889781', 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='快递公司表' AUTO_INCREMENT=426 ;
...
CREATE TABLE IF NOT EXISTS `eb_routine_access_token` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='小程序access_token表' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `eb_routine_form_id` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='表单id表记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_routine_qrcode` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='小程序二维码管理表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信模板' AUTO_INCREMENT=23 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_bargain` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='砍价表' AUTO_INCREMENT=7 ;
...
(2, 3, '加湿器 智能 白色', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '件', 999, 1, '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg"]', 1546272000, 1551283200, '智米加湿器 白色 4L', '249.00', '1.00', 1, '10.00', '0.01', 1, 0, '', '249.00', '加湿器 智能 白色', '10.00', 0, 1, 1, 0, 1, '0.00', '', 15, 0),
(3, 1, '测试', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '件', 576, 41, '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', 1553011200, 1556553600, '无线吸尘器F8 玫瑰金礼盒版', '2.00', '0.00', 1, '2.00', '1.00', 1, 1, NULL, '1699.00', '测试', '100.00', 1, 1, 0, NULL, 1, '1.00', NULL, 388, 24),
(4, 2, '测试2', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '件', 992, 15, '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg"]', 1553011200, 1556553600, '智能马桶盖 AI版', '3.00', '0.00', 1, '2.00', '1.00', 1, 1, '只能马桶限时砍价活动<p></p>', '1999.00', '测试2', '1500.00', 0, 1, 0, NULL, 1, '0.00', '<p>没人限购一件哦</p><p>活动截止时间：2019-05-01</p><p></p>', 137, 13),
(5, 3, '砍价活动测试产品', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '件', 999, 41, '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg"]', 1554912000, 1555689600, '智米加湿器 白色', '11.00', '0.00', 1, '3.00', '2.00', 1, 1, NULL, '249.00', '砍价活动测试产品', '10.00', 0, 1, 0, NULL, 1, '0.00', NULL, 5, 2),
(6, 4, '10人砍价', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc23646fff.jpg', '件', 418, 82, '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc23646fff.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg"]', 1554825600, 1556553600, '互联网电热水器1A', '100.00', '0.00', 1, '11.00', '9.00', 1, 1, NULL, '999.00', '10人砍价', '888.00', 0, 1, 0, NULL, 1, '0.00', NULL, 46, 5);
...
CREATE TABLE IF NOT EXISTS `eb_store_bargain_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户参与砍价表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_bargain_user_help` (
  ...
  `add_time` int(11) unsigned DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='砍价用户帮助表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品分类表' AUTO_INCREMENT=29 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_combination` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='拼团产品表' AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `eb_store_combination`
--

INSERT INTO `eb_store_combination` (`id`, `product_id`, `mer_id`, `image`, `images`, `title`, `attr`, `people`, `info`, `price`, `sort`, `sales`, `stock`, `add_time`, `is_host`, `is_show`, `is_del`, `combination`, `mer_use`, `is_postage`, `postage`, `description`, `start_time`, `stop_time`, `cost`, `browse`, `unit_name`) VALUES
(1, 1, 0, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', '3人团 无线吸尘器F8 玫瑰金礼盒版', '', 3, '年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元', '1.00', 0, 20, 980, '1547554180', 1, 1, 1, 1, 0, 1, '1.00', '', 1546272000, 1551283200, 0, 4, ''),
(2, 3, 0, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg"]', '智米加湿器 白色', '', 6, '智米加湿器 白色', '199.00', 0, 0, 999, '1547554327', 1, 1, 1, 1, 0, 1, '0.00', '', 1546272000, 1551283200, 0, 3, ''),
...
(4, 3, 0, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg"]', '测试', NULL, 2, '测试', '0.01', 0, 537, 463, '1554909810', 1, 1, 0, 1, NULL, 1, '0.00', '', 1554825600, 1559232000, 0, 0, ''),
(5, 1, 0, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', '5人团：无线吸尘器F8 玫瑰金礼盒版', NULL, 5, '【年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元】', '0.01', 0, 231, 5858, '1555125024', 1, 1, 0, 1, NULL, 1, '1.00', '', 1554998400, 1556553600, 0, 0, ''),
(6, 2, 0, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg"]', '10人团：智能马桶盖 AI版', NULL, 10, '智能马桶盖 AI版', '0.01', 0, 53, 9934, '1555125049', 1, 1, 0, 1, NULL, 1, '0.00', '', 1554998400, 1556553600, 0, 0, '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='优惠券表' AUTO_INCREMENT=6 ;
...
(1, '测试优惠券满10减9.9', 0, '9.90', '1.00', 100, 1, 0, 1547714661, 1),
(2, '你好', 0, '3.00', '4.00', 100, 0, 1, 1547714872, 1),
(3, '迷惑', 0, '5.00', '1.00', 100, 0, 0, 1547714900, 1),
(4, '测试 2019.3.21.21.22', 0, '1.00', '0.00', 10, 0, 1, 1553174564, 0),
(5, '20元优惠券满100可用', 0, '20.00', '100.00', 100, 0, 1, 1553910760, 0);
...
CREATE TABLE IF NOT EXISTS `eb_store_coupon_issue` (
  ...
  KEY `is_del` (`is_del`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='优惠券前台领取表' AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `eb_store_coupon_issue`
--

INSERT INTO `eb_store_coupon_issue` (`id`, `cid`, `start_time`, `end_time`, `total_count`, `remain_count`, `is_permanent`, `status`, `is_del`, `add_time`) VALUES
(1, 2, 1547654400, 1547827200, 10, 5, 0, 1, 1, 1547714939),
(2, 4, 0, 0, 5, -6, 0, 1, 0, 1553174582),
(3, 4, 0, 0, 10, -10, 0, 1, 0, 1553825963),
(4, 4, 0, 0, 100, 63, 0, 1, 0, 1553833182),
(5, 4, 1553788800, 1559232000, 0, 0, 0, 1, 0, 1553910539),
(6, 5, 0, 0, 0, 0, 0, 1, 0, 1553910772);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='优惠券发放记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_pink` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='拼团表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品表' AUTO_INCREMENT=6 ;
...
(1, 0, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', '无线吸尘器F8 玫瑰金礼盒版', '【年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元】', '无线吸尘器', '2', '0.01', '0.00', '1699.00', '1.00', '件', 1, 240, 586, 1, 1, 0, 1, 1, '<p><img src="http://datong.crmeb.net/public/uploads/editor/20190115/5c3dbb137d656.jpeg"/><img src="http://datong.crmeb.net/public/uploads/editor/20190115/5c3dbb229e820.jpeg"/><img src="http://datong.crmeb.net/public/uploads/editor/20190115/5c3dbb3b37f84.jpeg"/><img src="http://datong.crmeb.net/public/uploads/editor/20190115/5c3dbb513b06f.jpeg"/></p>', 1547205504, 1, 0, 0, '1699.00', '100.00', 0, 0, 81, 0, ''),
...
(5, 0, 'http://datong.crmeb.net/public/uploads/editor/20190115/5c3dbb513b06f.jpeg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/editor\\/20190115\\/5c3dc294a9a0a.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/editor\\/20190115\\/5c3dbb513b06f.jpeg"]', '测试', '阿萨德啊', '去', '4,7,2,3,19', '1.00', '0.00', '1.00', '0.00', '件', 0, 0, 111, 1, 0, 0, 0, 0, '', 1554863537, 0, 0, 0, '1.00', '1.00', 0, NULL, 1, 0, '');
...
(2, '40cm', 990, 4, '888.00', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc6a38fab.jpg', '19f1d772', '1500.00'),
(1, '黑色', 71, 128, '0.01', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '6af2068e', '100.00'),
(3, '4L,白色', 990, 9, '289.00', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '824485b3', '10.00'),
(1, '白色', 169, 30, '0.02', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3db9de2b73a.jpg', 'a84fff47', '100.00'),
(3, '3L,白色', 987, 12, '248.00', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', 'ab6067b3', '10.00'),
(3, '3L,黑色', 993, 6, '249.00', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc15ba1972.jpg', 'afb4949f', '10.00'),
(2, '30cm', 957, 37, '0.01', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', 'bae75a3a', '1500.00'),
(3, '4L,黑色', 983, 16, '299.00', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc15ba1972.jpg', 'c4b7ce93', '10.00'),
(1, '蓝色', 137, 62, '0.03', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba4187461.jpg', 'f39d47dc', '100.00');
...
CREATE TABLE IF NOT EXISTS `eb_store_product_cate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品分类辅助表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='评论表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_seckill` (
  ...
  KEY `sort` (`sort`) USING BTREE,
  KEY `is_postage` (`is_postage`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品秒杀产品表' AUTO_INCREMENT=13 ;
...
(1, 1, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', '手慢无 无线吸尘器F8 玫瑰金礼盒版', '【年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元】', '0.01', '100.00', '599.00', '1699.00', 1, 953, 47, '件', '0.00', '', '1553702400', '1556553600', '1553847138', 1, 1, 1, 1, 1, 1),
...
(4, 4, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc23646fff.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc23646fff.jpg"]', '互联网电热水器1A', '3000w双管速热，动态360L热水用量，双重漏电保护，智能APP操控', '10.00', '888.00', '999.00', '999.00', 0, 441, 59, '件', '0.00', NULL, '1554861600', '1554868799', '1554860320', 1, 1, 1, 1, 1, 1),
(5, 1, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', '7-10点 无线吸尘器F8 玫瑰金礼盒版', '【年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元】', '0.01', '100.00', '1.00', '1699.00', 1, 586, 159, '件', '1.00', NULL, '1554850800', '1554861600', '1554860478', 1, 1, 1, 1, 1, 1),
(6, 2, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg"]', '10-12点智能马桶盖 AI版', '智能马桶盖 AI版', '0.01', '1500.00', '100.00', '1999.00', 0, 994, 31, '件', '0.00', NULL, '1554876000', '1554883200', '1554876551', 1, 1, 1, 1, 1, 1),
(7, 3, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg"]', '12-14智米加湿器 白色', '智米加湿器 白色', '0.01', '10.00', '249.00', '249.00', 0, 999, 17, '件', '0.00', NULL, '1554876000', '1554883200', '1554877858', 1, 1, 1, 1, 1, 1),
(8, 1, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg"]', '12-14无线吸尘器F8 玫瑰金礼盒版', '【年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元】', '0.01', '100.00', '10.00', '1699.00', 1, 586, 173, '件', '1.00', NULL, '1554998400', '1556553600', '1555148238', 1, 1, 1, 0, 1, 1),
(9, 2, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg"]', '14-16智能马桶盖 AI版', '智能马桶盖 AI版', '0.01', '1500.00', '0.01', '1999.00', 0, 994, 33, '件', '0.00', NULL, '1554876000', '1554883199', '1554887359', 1, 1, 1, 0, 1, 1),
(10, 3, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg"]', '智米加湿器 白色', '智米加湿器 白色', '0.01', '10.00', '249.00', '249.00', 0, 998, 40, '件', '0.00', NULL, '1554998400', '1556553600', '1555148264', 1, 1, 1, 0, 1, 1),
(11, 2, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg","http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg"]', '智能马桶盖 AI版', '智能马桶盖 AI版', '0.01', '1500.00', '0.01', '1999.00', 0, 993, 45, '件', '0.00', NULL, '1554998400', '1556553600', '1555148291', 1, 1, 1, 0, 1, 1),
(12, 4, 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc23646fff.jpg', '["http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc23646fff.jpg"]', '互联网电热水器1A', '3000w双管速热，动态360L热水用量，双重漏电保护，智能APP操控', '1.00', '888.00', '999.00', '999.00', 0, 420, 80, '件', '0.00', NULL, '1554998400', '1556553600', '1555148278', 1, 1, 1, 0, 1, 1);
...
CREATE TABLE IF NOT EXISTS `eb_store_service` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='客服表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_service_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='客服用户对话记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_store_visit` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品浏览分析表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_admin` (
  ...
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='后台管理员表' AUTO_INCREMENT=2 ;
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', '1', '127.0.0.1', 1555932996, 1555932970, 0, 0, 1, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='附件管理表' AUTO_INCREMENT=97 ;
...
(9, '5c3db5d483c7e.jpg', '/public/uploads/attach/2019/01/15/5c3db5d483c7e.jpg', '/public/uploads/attach/2019/01/15/s_5c3db5d483c7e.jpg', '41833', 'image/jpeg', 3, 1547548116),
...
(46, '5c9ccc99101a8.png', '/public/uploads/attach/2019/03/28/5c9ccc99101a8.png', '/public/uploads/attach/2019/03/28/s_5c9ccc99101a8.png', '2120', 'image/png', 4, 1553779865),
...
(49, '5c9ccc99269d1.png', '/public/uploads/attach/2019/03/28/5c9ccc99269d1.png', '/public/uploads/attach/2019/03/28/s_5c9ccc99269d1.png', '2007', 'image/png', 4, 1553779865),
...
(59, '5c9ccca8a27f0.png', '/public/uploads/attach/2019/03/28/5c9ccca8a27f0.png', '/public/uploads/attach/2019/03/28/s_5c9ccca8a27f0.png', '3138', 'image/png', 6, 1553779880),
(60, '5c9ccca8aa5b9.png', '/public/uploads/attach/2019/03/28/5c9ccca8aa5b9.png', '/public/uploads/attach/2019/03/28/s_5c9ccca8aa5b9.png', '4066', 'image/png', 6, 1553779880),
(61, '5c9ccca8b27f1.jpg', '/public/uploads/attach/2019/03/28/5c9ccca8b27f1.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccca8b27f1.jpg', '25834', 'image/jpeg', 6, 1553779880),
(62, '5c9ccca8bc1e0.png', '/public/uploads/attach/2019/03/28/5c9ccca8bc1e0.png', '/public/uploads/attach/2019/03/28/s_5c9ccca8bc1e0.png', '3907', 'image/png', 6, 1553779880),
(63, '5c9ccca8c3bff.jpg', '/public/uploads/attach/2019/03/28/5c9ccca8c3bff.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccca8c3bff.jpg', '22916', 'image/jpeg', 6, 1553779880),
(64, '5c9ccca8cd632.jpg', '/public/uploads/attach/2019/03/28/5c9ccca8cd632.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccca8cd632.jpg', '24602', 'image/jpeg', 6, 1553779880),
(65, '5c9ccca8d6ae1.jpg', '/public/uploads/attach/2019/03/28/5c9ccca8d6ae1.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccca8d6ae1.jpg', '21491', 'image/jpeg', 6, 1553779880),
(66, '5c9ccca8dfe16.jpg', '/public/uploads/attach/2019/03/28/5c9ccca8dfe16.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccca8dfe16.jpg', '27120', 'image/jpeg', 6, 1553779880),
(67, '5c9ccca8e9365.png', '/public/uploads/attach/2019/03/28/5c9ccca8e9365.png', '/public/uploads/attach/2019/03/28/s_5c9ccca8e9365.png', '3648', 'image/png', 6, 1553779880),
(68, '5c9ccca8f0a30.png', '/public/uploads/attach/2019/03/28/5c9ccca8f0a30.png', '/public/uploads/attach/2019/03/28/s_5c9ccca8f0a30.png', '3066', 'image/png', 6, 1553779880),
(69, '5c9ccca904016.jpg', '/public/uploads/attach/2019/03/28/5c9ccca904016.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccca904016.jpg', '24567', 'image/jpeg', 6, 1553779881),
(70, '5c9ccca90d2d3.png', '/public/uploads/attach/2019/03/28/5c9ccca90d2d3.png', '/public/uploads/attach/2019/03/28/s_5c9ccca90d2d3.png', '4409', 'image/png', 6, 1553779881),
(71, '5c9ccf7e97660.jpg', '/public/uploads/attach/2019/03/28/5c9ccf7e97660.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccf7e97660.jpg', '18640', 'image/jpeg', 2, 1553780606),
(72, '5c9ccf7e9f4d0.jpg', '/public/uploads/attach/2019/03/28/5c9ccf7e9f4d0.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccf7e9f4d0.jpg', '29549', 'image/jpeg', 2, 1553780606),
(73, '5c9ccfc86a6c1.jpg', '/public/uploads/attach/2019/03/28/5c9ccfc86a6c1.jpg', '/public/uploads/attach/2019/03/28/s_5c9ccfc86a6c1.jpg', '22379', 'image/jpeg', 2, 1553780680),
(74, '5c9cd03224d59.jpg', '/public/uploads/attach/2019/03/28/5c9cd03224d59.jpg', '/public/uploads/attach/2019/03/28/s_5c9cd03224d59.jpg', '178435', 'image/jpeg', 2, 1553780786),
(75, '5c9ddc9f34bfd.png', '/public/uploads/attach/2019/03/29/5c9ddc9f34bfd.png', '/public/uploads/attach/2019/03/29/s_5c9ddc9f34bfd.png', '4453', 'image/png', 2, 1553849503),
(76, '5c9ddccecb7f3.png', '/public/uploads/attach/2019/03/29/5c9ddccecb7f3.png', '/public/uploads/attach/2019/03/29/s_5c9ddccecb7f3.png', '4522', 'image/png', 2, 1553849550),
(77, '5c9ddcec57a80.png', '/public/uploads/attach/2019/03/29/5c9ddcec57a80.png', '/public/uploads/attach/2019/03/29/s_5c9ddcec57a80.png', '2703', 'image/png', 2, 1553849580),
(78, '5c9ddd570b8b3.png', '/public/uploads/attach/2019/03/29/5c9ddd570b8b3.png', '/public/uploads/attach/2019/03/29/s_5c9ddd570b8b3.png', '2825', 'image/png', 2, 1553849687),
(79, '5c9dddce0eac9.png', '/public/uploads/attach/2019/03/29/5c9dddce0eac9.png', '/public/uploads/attach/2019/03/29/s_5c9dddce0eac9.png', '4784', 'image/png', 2, 1553849806),
(80, '5c9dde013f63c.png', '/public/uploads/attach/2019/03/29/5c9dde013f63c.png', '/public/uploads/attach/2019/03/29/s_5c9dde013f63c.png', '3672', 'image/png', 2, 1553849857),
(81, '5c9dde246ad96.png', '/public/uploads/attach/2019/03/29/5c9dde246ad96.png', '/public/uploads/attach/2019/03/29/s_5c9dde246ad96.png', '4982', 'image/png', 2, 1553849892),
(82, '5c9ddedbed782.png', '/public/uploads/attach/2019/03/29/5c9ddedbed782.png', '/public/uploads/attach/2019/03/29/s_5c9ddedbed782.png', '6454', 'image/png', 2, 1553850075),
(83, '5c9de8b7c5cc5.png', '/public/uploads/attach/2019/03/29/5c9de8b7c5cc5.png', '/public/uploads/attach/2019/03/29/s_5c9de8b7c5cc5.png', '124578', 'image/png', 7, 1553852599),
(84, '5c9def00c2882.png', '/public/uploads/attach/2019/03/29/5c9def00c2882.png', '/public/uploads/attach/2019/03/29/s_5c9def00c2882.png', '90279', 'image/png', 7, 1553854208),
(85, '5c9def5fa968c.png', '/public/uploads/attach/2019/03/29/5c9def5fa968c.png', '/public/uploads/attach/2019/03/29/s_5c9def5fa968c.png', '139059', 'image/png', 7, 1553854303),
(86, '5c9df11e13742.png', '/public/uploads/attach/2019/03/29/5c9df11e13742.png', '/public/uploads/attach/2019/03/29/s_5c9df11e13742.png', '137246', 'image/png', 7, 1553854750),
(87, '5c9df170010cb.png', '/public/uploads/attach/2019/03/29/5c9df170010cb.png', '/public/uploads/attach/2019/03/29/s_5c9df170010cb.png', '212939', 'image/png', 7, 1553854832),
(88, '5c9df1b8f0a7a.png', '/public/uploads/attach/2019/03/29/5c9df1b8f0a7a.png', '/public/uploads/attach/2019/03/29/s_5c9df1b8f0a7a.png', '198726', 'image/png', 7, 1553854905),
(89, '5c9e015bdc6f5.jpg', '/public/uploads/attach/2019/03/29/5c9e015bdc6f5.jpg', '/public/uploads/attach/2019/03/29/s_5c9e015bdc6f5.jpg', '161959', 'image/jpeg', 3, 1553858907),
(90, '5c9e1ef640019.jpg', '/public/uploads/attach/2019/03/29/5c9e1ef640019.jpg', '/public/uploads/attach/2019/03/29/s_5c9e1ef640019.jpg', '154063', 'image/jpeg', 8, 1553866486),
(92, '5cb039675597c.jpg', '/public/uploads/attach/2019/04/12/5cb039675597c.jpg', '/public/uploads/attach/2019/04/12/s_5cb039675597c.jpg', '24890', 'image/jpeg', 8, 1555052903),
(93, '5cb071e576b3d.jpg', '/public/uploads/attach/2019/04/12/5cb071e576b3d.jpg', '/public/uploads/attach/2019/04/12/s_5cb071e576b3d.jpg', '165730', 'image/jpeg', 8, 1555067365),
(94, '5cb071e5860fa.jpg', '/public/uploads/attach/2019/04/12/5cb071e5860fa.jpg', '/public/uploads/attach/2019/04/12/s_5cb071e5860fa.jpg', '97039', 'image/jpeg', 8, 1555067365),
(95, '5cb18df0dfba7.jpg', '/public/uploads/attach/2019/04/13/5cb18df0dfba7.jpg', '/public/uploads/attach/2019/04/13/s_5cb18df0dfba7.jpg', '213277', 'image/jpeg', 3, 1555140080),
(96, '5cb18e247a1a9.jpg', '/public/uploads/attach/2019/04/13/5cb18e247a1a9.jpg', '/public/uploads/attach/2019/04/13/s_5cb18e247a1a9.jpg', '56623', 'image/jpeg', 3, 1555140132);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='附件分类表' AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_config` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='配置表' AUTO_INCREMENT=108 ;
...
(1, 'site_name', 'text', 1, '', 0, 'required:true', 100, 0, '"CRMEB\\u5ba2\\u6e90"', '网站名称', '网站名称', 0, 1),
(2, 'site_url', 'text', 1, '', 0, 'required:true,url:true', 100, 0, '"http:\\/\\/datong.crmeb.net"', '网站地址', '网站地址', 0, 1),
(3, 'site_logo', 'upload', 1, '', 1, '', 0, 0, '""', '后台LOGO', '左上角logo,建议尺寸[170*50]', 0, 1),
(4, 'site_phone', 'text', 1, '', 0, '', 100, 0, '""', '联系电话', '联系电话', 0, 1),
(5, 'seo_title', 'text', 1, '', 0, 'required:true', 100, 0, '"crmeb\\u7535\\u5546\\u7cfb\\u7edf"', 'SEO标题', 'SEO标题', 0, 1),
(6, 'site_email', 'text', 1, '', 0, 'email:true', 100, 0, '"admin@xazbkj.com"', '联系邮箱', '联系邮箱', 0, 1),
...
(10, 'wechat_name', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', '公众号名称', '公众号的名称', 0, 1),
(11, 'wechat_id', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', '微信号', '微信号', 0, 1),
(12, 'wechat_sourceid', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', '公众号原始id', '公众号原始id', 0, 1),
(13, 'wechat_appid', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', 'AppID', 'AppID', 0, 1),
(14, 'wechat_appsecret', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', 'AppSecret', 'AppSecret', 0, 1),
(15, 'wechat_token', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', '微信验证TOKEN', '微信验证TOKEN', 0, 1),
(16, 'wechat_encode', 'radio', 2, '0=>明文模式\n1=>兼容模式\n2=>安全模式', 0, '', 0, 0, '"0"', '消息加解密方式', '如需使用安全模式请在管理中心修改，仅限服务号和认证订阅号', 0, 1),
(17, 'wechat_encodingaeskey', 'text', 2, '', 0, 'required:true', 100, 0, '"CRMEB"', 'EncodingAESKey', '公众号消息加解密Key,在使用安全模式情况下要填写该值，请先在管理中心修改，然后填写该值，仅限服务号和认证订阅号', 0, 1),
...
(21, 'wechat_share_title', 'text', 3, '', 0, 'required:true', 100, 0, '"CRMEB"', '微信分享标题', '微信分享标题', 0, 1),
(22, 'wechat_share_synopsis', 'textarea', 3, '', 0, '', 100, 5, '"CRMEB"', '微信分享简介', '微信分享简介', 0, 1),
(23, 'pay_weixin_appid', 'text', 4, '', 0, '', 100, 0, '"CRMEB"', 'Appid', '微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看。', 0, 1),
(24, 'pay_weixin_appsecret', 'text', 4, '', 0, '', 100, 0, '"CRMEB"', 'Appsecret', 'JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看。', 0, 1),
(25, 'pay_weixin_mchid', 'text', 4, '', 0, '', 100, 0, '"CRMEB"', 'Mchid', '受理商ID，身份标识', 0, 1),
...
(28, 'pay_weixin_key', 'text', 4, '', 0, '', 100, 0, '"CRMEB"', 'Key', '商户支付密钥Key。审核通过后，在微信发送的邮件中查看。', 0, 1),
...
(56, 'store_home_pink', 'upload', 5, '', 1, '', 0, 0, '"\\/public\\/uploads\\/config\\/image\\/5c3dd2ffb2616.jpeg"', '首页拼团广告图', '首页拼团广告图', 0, 1),
...
(59, 'routine_appId', 'text', 7, '', 0, '', 100, 0, '"CRMEB"', 'appId', '小程序appID', 0, 1),
(60, 'routine_appsecret', 'text', 7, '', 0, '', 100, 0, '"CRMEB"', 'AppSecret', '小程序AppSecret', 0, 1),
...
(73, 'routine_logo', 'upload', 7, '', 1, '', 0, 0, '"\\/public\\/uploads\\/config\\/image\\/5c9cd841a76fe.png"', '小程序logo', '小程序logo', 0, 1),
(74, 'routine_name', 'text', 7, '', 0, '', 100, 0, '"CRMEB"', '小程序名称', '小程序名称', 0, 1),
(76, 'routine_style', 'text', 7, '', 0, '', 100, 0, '""', '小程序风格', '小程序颜色', 0, 1),
...
(89, 'pay_routine_appid', 'text', 14, '', 0, 'required:true', 100, 0, '"0"', 'Appid', '小程序Appid', 0, 1),
(90, 'pay_routine_appsecret', 'text', 14, '', 0, 'required:true', 100, 0, '"0"', 'Appsecret', '小程序Appsecret', 0, 1),
(91, 'pay_routine_mchid', 'text', 14, '', 0, 'required:true', 100, 0, '"0"', 'Mchid', '商户号', 0, 1),
(92, 'pay_routine_key', 'text', 14, '', 0, 'required:true', 100, 0, '"0"', 'Key', '商户key', 0, 1),
...
(107, 'routine_index_logo', 'upload', 7, NULL, 1, NULL, NULL, NULL, '"\\/public\\/uploads\\/config\\/image\\/5cb0448eed9cb.png"', '小程序主页logo图标', '小程序主页logo图标', 0, 1);
...
CREATE TABLE IF NOT EXISTS `eb_system_config_tab` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='配置分类表' AUTO_INCREMENT=17 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_file` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文件对比表' AUTO_INCREMENT=2116 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组合数据表' AUTO_INCREMENT=61 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_group_data` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组合数据详情表' AUTO_INCREMENT=169 ;
...
(72, 35, '{"name":{"type":"input","value":"\\u780d\\u4ef7"},"url":{"type":"input","value":"\\/wap\\/store\\/cut_list.html"},"icon":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc72335ee5.png"}}', 1515985426, 1, 1),
...
(74, 35, '{"name":{"type":"input","value":"\\u62fc\\u56e2"},"url":{"type":"input","value":"\\/wap\\/store\\/combination.html"},"icon":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc73feecaf.png"}}', 1515985441, 1, 1),
(80, 36, '{"info":{"type":"input","value":"CRMEB\\u7535\\u5546\\u7cfb\\u7edf V 2.6 \\u5373\\u5c06\\u4e0a\\u7ebf\\uff01"},"url":{"type":"input","value":"#"}}', 1515985907, 1, 1),
(81, 36, '{"info":{"type":"input","value":"CRMEB\\u5546\\u57ce V 2.6 \\u5c0f\\u7a0b\\u5e8f\\u516c\\u4f17\\u53f7\\u6570\\u636e\\u540c\\u6b65\\uff01"},"url":{"type":"input","value":"#"}}', 1515985918, 1, 1),
...
(91, 37, '{"img":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/04\\/13\\/5cb18df0dfba7.jpg"},"comment":{"type":"input","value":"\\u79d2\\u6740\\u5217\\u8868\\u9876\\u90e8baaner"}}', 1528688012, 1, 1),
...
(99, 47, '{"name":{"type":"input","value":"\\u5546\\u54c1\\u5206\\u7c7b"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9ddc9f34bfd.png"},"url":{"type":"select","value":"\\/pages\\/goods_cate\\/goods_cate"},"show":{"type":"radio","value":"1"}}', 1533721963, 8, 1),
(100, 47, '{"name":{"type":"input","value":"\\u9886\\u4f18\\u60e0\\u5238"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9ddccecb7f3.png"},"url":{"type":"select","value":"\\/pages\\/user_get_coupon\\/index"},"show":{"type":"radio","value":"2"}}', 1533722009, 7, 1),
(101, 47, '{"name":{"type":"input","value":"\\u884c\\u4e1a\\u8d44\\u8baf"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9ddcec57a80.png"},"url":{"type":"select","value":"\\/pages\\/news_list\\/index"},"show":{"type":"radio","value":"2"}}', 1533722037, 6, 1),
(102, 47, '{"name":{"type":"input","value":"\\u6211\\u8981\\u7b7e\\u5230"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9ddd570b8b3.png"},"url":{"type":"select","value":"\\/pages\\/user_sgin\\/index"},"show":{"type":"radio","value":"2"}}', 1533722063, 5, 1),
(104, 48, '{"name":{"type":"input","value":"banenr2"},"url":{"type":"input","value":"#"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9e015bdc6f5.jpg"}}', 1533722286, 10, 1),
(105, 47, '{"name":{"type":"input","value":"\\u6211\\u7684\\u6536\\u85cf"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9dddce0eac9.png"},"url":{"type":"select","value":"\\/pages\\/user_goods_collection\\/index"},"show":{"type":"radio","value":"2"}}', 1533797064, 5, 1),
(106, 32, '{"name":{"type":"input","value":"\\u6211\\u7684\\u780d\\u4ef7"},"icon":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc97a19134.png"},"url":{"type":"select","value":"\\/wap\\/my\\/user_cut.html"}}', 1533889033, 1, 1),
(108, 35, '{"name":{"type":"input","value":"\\u79d2\\u6740"},"url":{"type":"input","value":"\\/wap\\/store\\/seckill_index.html"},"icon":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc730dead2.png"}}', 1541054595, 1, 1),
...
(121, 50, '{"info":{"type":"input","value":"CRMEB\\u7535\\u5546\\u7cfb\\u7edf V 2.6 \\u5373\\u5c06\\u4e0a\\u7ebf\\uff01"},"url":{"type":"select","value":"\\/pages\\/index\\/index"},"show":{"type":"radio","value":"\\u662f"}}', 1552611989, 1, 1),
(122, 50, '{"info":{"type":"input","value":"CRMEB\\u7535\\u5546\\u7cfb\\u7edf V 2.6 \\u5373\\u5c06\\u4e0a\\u7ebf\\uff01"},"url":{"type":"select","value":"\\/pages\\/miao-list\\/miao-list"},"show":{"type":"radio","value":"\\u5426"}}', 1552612003, 1, 1),
(123, 50, '{"info":{"type":"input","value":"CRMEB\\u7535\\u5546\\u7cfb\\u7edf V 2.6 \\u5373\\u5c06\\u4e0a\\u7ebf\\uff01"},"url":{"type":"select","value":"\\/pages\\/index\\/index"},"show":{"type":"radio","value":"\\u662f"}}', 1552613047, 1, 1),
(124, 51, '{"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccf7e9f4d0.jpg"},"title":{"type":"input","value":"\\u4e00\\u8d77\\u6765\\u62fc\\u56e2"},"info":{"type":"input","value":"\\u4f18\\u60e0\\u591a\\u591a"},"link":{"type":"select","value":"\\/pages\\/activity\\/goods_combination\\/index"}}', 1552620002, 3, 1),
(125, 51, '{"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccf7e97660.jpg"},"title":{"type":"input","value":"\\u79d2\\u6740\\u4e13\\u533a"},"info":{"type":"input","value":"\\u65b0\\u80fd\\u6e90\\u6c7d\\u8f66\\u706b\\u70ed\\u9500\\u552e"},"link":{"type":"select","value":"\\/pages\\/activity\\/goods_seckill\\/index"}}', 1552620022, 2, 1),
(126, 51, '{"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccfc86a6c1.jpg"},"title":{"type":"input","value":"\\u780d\\u4ef7\\u6d3b\\u52a8"},"info":{"type":"input","value":"\\u547c\\u670b\\u5524\\u53cb\\u6765\\u780d\\u4ef7~~~"},"link":{"type":"select","value":"\\/pages\\/activity\\/goods_bargain\\/index"}}', 1552620041, 1, 1),
(127, 52, '{"img":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/04\\/13\\/5cb18e247a1a9.jpg"},"comment":{"type":"input","value":"\\u7cbe\\u54c1\\u63a8\\u8350750*282"},"link":{"type":"input","value":"\\/pages\\/first-new-product\\/index"}}', 1552633893, 1, 1),
(128, 52, '{"img":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9e015bdc6f5.jpg"},"comment":{"type":"input","value":"\\u7cbe\\u54c1\\u63a8\\u8350750*282"},"link":{"type":"input","value":"\\/pages\\/first-new-product\\/index"}}', 1552633912, 1, 1),
(135, 54, '{"name":{"type":"input","value":"\\u4f1a\\u5458\\u4e2d\\u5fc3"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc9934a7c.png"},"url":{"type":"select","value":"\\/pages\\/user_vip\\/index"}}', 1553779918, 1, 1),
(136, 54, '{"name":{"type":"input","value":"\\u780d\\u4ef7\\u8bb0\\u5f55"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc9918091.png"},"url":{"type":"select","value":"\\/pages\\/activity\\/user_goods_bargain_list\\/index"}}', 1553779935, 1, 2),
(137, 54, '{"name":{"type":"input","value":"\\u6211\\u7684\\u63a8\\u5e7f"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc9943575.png"},"url":{"type":"select","value":"\\/pages\\/user_spread_user\\/index"}}', 1553779950, 1, 1),
(138, 54, '{"name":{"type":"input","value":"\\u6211\\u7684\\u4f59\\u989d"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc992db31.png"},"url":{"type":"select","value":"\\/pages\\/user_money\\/index"}}', 1553779973, 1, 1),
(139, 54, '{"name":{"type":"input","value":"\\u5730\\u5740\\u4fe1\\u606f"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc99101a8.png"},"url":{"type":"select","value":"\\/pages\\/user_address_list\\/index"}}', 1553779988, 1, 1),
(140, 54, '{"name":{"type":"input","value":"\\u6211\\u7684\\u6536\\u85cf"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc99269d1.png"},"url":{"type":"select","value":"\\/pages\\/user_goods_collection\\/index"}}', 1553780003, 1, 1),
(141, 54, '{"name":{"type":"input","value":"\\u4f18\\u60e0\\u5238"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc991f394.png"},"url":{"type":"select","value":"\\/pages\\/user_coupon\\/index"}}', 1553780017, 1, 1),
...
(155, 58, '{"img":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9cd03224d59.jpg"},"comment":{"type":"input","value":"1"},"link":{"type":"input","value":"#"}}', 1553780869, 1, 1),
...
(158, 47, '{"name":{"type":"input","value":"\\u62fc\\u56e2\\u6d3b\\u52a8"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9dde013f63c.png"},"url":{"type":"select","value":"\\/pages\\/activity\\/goods_combination\\/index"},"show":{"type":"radio","value":"2"}}', 1553849878, 3, 1),
(159, 47, '{"name":{"type":"input","value":"\\u79d2\\u6740\\u6d3b\\u52a8"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9dde246ad96.png"},"url":{"type":"select","value":"\\/pages\\/activity\\/goods_seckill\\/index"},"show":{"type":"radio","value":"2"}}', 1553849905, 2, 1),
(160, 47, '{"name":{"type":"input","value":"\\u780d\\u4ef7\\u6d3b\\u52a8"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9ddedbed782.png"},"url":{"type":"select","value":"\\/pages\\/activity\\/goods_bargain\\/index"},"show":{"type":"radio","value":"2"}}', 1553850093, 1, 1),
(161, 60, '{"title":{"type":"input","value":"\\u5206\\u4eab\\u6d77\\u62a5"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/29\\/5c9e1ef640019.jpg"}}', 1553866489, 1, 1),
(162, 54, '{"name":{"type":"input","value":"\\u780d\\u4ef7\\u8bb0\\u5f55"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/03\\/28\\/5c9ccc9918091.png"},"url":{"type":"select","value":"\\/pages\\/activity\\/user_goods_bargain_list\\/index"}}', 1553866805, 1, 1),
...
(167, 60, '{"title":{"type":"input","value":"1"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/04\\/12\\/5cb071e5860fa.jpg"}}', 1555063900, 1, 1),
(168, 60, '{"title":{"type":"input","value":"2"},"pic":{"type":"upload","value":"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/04\\/12\\/5cb071e576b3d.jpg"}}', 1555067377, 1, 1);
...
CREATE TABLE IF NOT EXISTS `eb_system_log` (
  ...
  KEY `add_time` (`add_time`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员操作记录表' AUTO_INCREMENT=4 ;
...
(1, 1, 'admin', 'admin/system.systemcleardata/wechatuserdata/', '未知', 'GET', '127.0.0.1', 'system', 1555933340, 0),
(2, 1, 'admin', 'admin/system.systemcleardata/wechatdata/', '未知', 'GET', '127.0.0.1', 'system', 1555933345, 0),
(3, 1, 'admin', 'admin/system.systemcleardata/userrelevantdata/', '未知', 'GET', '127.0.0.1', 'system', 1555933352, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单表' AUTO_INCREMENT=472 ;
...
(270, 269, '', '小程序配置', 'admin', 'setting.systemConfig', 'index', '{"type":"2","tab_id":"7"}', 0, 1, 1),
...
(471, 462, '', '小程序精品推荐', 'admin', 'setting.system_group_data', 'index', '{"gid":"52"}', 0, 0, 1);
...
CREATE TABLE IF NOT EXISTS `eb_system_notice` (
  ...
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='通知模板表' AUTO_INCREMENT=10 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='通知记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_role` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='身份管理表' AUTO_INCREMENT=24 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_user_level` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='设置用户等级表' AUTO_INCREMENT=7 ;
...
(1, 0, '普通会员', '0.00', 0, 1, 0, 1, 1, '99.00', 'http://datong.crmeb.net/public/uploads/attach/2019/03/28/5c9ccca8cd632.jpg', 'http://datong.crmeb.net/public/uploads/attach/2019/03/28/5c9ccca8bc1e0.png', '普通会员', 1553824559, 0),
...
(6, 0, '钻石会员', '0.00', 0, 1, 0, 1, 6, '88.00', 'http://datong.crmeb.net/public/uploads/attach/2019/03/28/5c9ccca8dfe16.jpg', 'http://datong.crmeb.net/public/uploads/attach/2019/03/28/5c9ccca90d2d3.png', '钻石会员', 1553824871, 0);
...
CREATE TABLE IF NOT EXISTS `eb_system_user_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='等级任务设置' AUTO_INCREMENT=15 ;
...
CREATE TABLE IF NOT EXISTS `eb_token` (
  ...
  `add_time` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='保存token随机字符串' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_address` (
  ...
  KEY `is_del` (`is_del`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户地址表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户账单表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_enter` (
  ...
  KEY `is_del` (`is_del`) USING BTREE,
  KEY `status` (`status`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商户申请表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户提现表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_group` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户分组表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_level` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户等级记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_notice` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户通知表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_notice_see` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户通知发送记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_recharge` (
  ...
  KEY `paid` (`paid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户充值表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_sign` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `uid` (`uid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='签到记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_task_finish` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户任务完成记录表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信回复表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_wechat_message` (
  ...
  KEY `type` (`type`) USING BTREE,
  KEY `add_time` (`add_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户行为记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_wechat_news_category` (
  ...
  `add_time` varchar(255) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图文消息管理表' AUTO_INCREMENT=31 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信二维码管理表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信关键字回复表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_wechat_template` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `tempkey` (`tempkey`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信模板' AUTO_INCREMENT=17 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信用户表' AUTO_INCREMENT=1 ;
